    ...
    <div class="container">
        ...
        <form action="{{ url('/savemag')}}">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="magnama" name="magnama" value="" placeholder="Tugas Magang...">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="maglok" name="maglok" placeholder="Alamat tempat magang..." value="">
            </div>				    
            <div class="form-group"> 
                <label for="street2_id" class="control-label">Persyaratan</label>
                <input type="text" class="form-control" id="magdesk" name="magdesk" placeholder="Pendidikan terakhir, Jurusan..." value="">
            </div>	  
